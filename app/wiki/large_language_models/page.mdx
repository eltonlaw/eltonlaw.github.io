...
1. Keep pretrained model frozen, train a classifier on the embedding
2. Keep pretrained model frozen, attach extra hidden layers and a new output layer
3. Don't freeze the model
