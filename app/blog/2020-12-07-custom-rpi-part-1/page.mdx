...
<PostFrontmatter
    postTitle="Building a Custom Raspberry Pi Image: Part 1"
    postDate="2020-12-07 4:29AM" />

Motivated by Jay Carlson's [Amp Hour podcast](https://theamphour.com/515-embedded-linux-with-jay-carlson/) and reading his blog post ["So You Want to Build an Embedded Linux System?"](https://jaycarlson.net/embedded-linux/). The following was done on a raspberry pi 3B.
